    ...
    var datatableLatestOrders = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: 'http://localhost/api/datatables/demos/default.php'
                    }
                },
                pageSize: 10,
                saveState: {
                    ...
                    var output = '\
                        <div class="kt-user-card-v2">\
                            <div class="kt-user-card-v2__pic">\
                                <img src="http://localhost/assets/media/client-logos/logo' + img + '" alt="photo">\
                            </div>\
                ...
                template: function(data, i) {
					...
					if (number > 5) {
						output = '<div class="kt-user-card-v2">\
							<div class="kt-user-card-v2__pic">\
								<img src="http://localhost/assets/media/users/' + user_img + '" alt="photo">\
							</div>\
							<div class="kt-user-card-v2__details">\
